...
import (
	"FarhanHafizh_50420460_pert3/model" //sesuaikan dengan nama folder (case sensitive)
	"database/sql"
	"fmt"
	"testing"
)
...
func init() {
	...
	password = ""
	host = "localhost"
	namaDB = "db_50420460" // Misal : db_13116429
	defaultDB = "mysql"
}
func TestDatabase(t *testing.T) {
	...
	/* Function Testing dibawah ini berfungsi untuk menghapus DB (Ap
	   abila ingin melakukan testing,
...
func initDatabase() (*sql.DB, error) {
	...
	/*
	   Catatan :
	   1. Baris kode yang dikomentari di bawah ini merupakan b
	   aris kode
	   untuk melakukan pembuatan tabel Matkul dan Nilai
	   2. Silahkan hilangkan komentar baris kode dibawah apabi
	   la telah membuat model dan test berupa :
	   - matakuliah.go
	   - nilai.go
	   - matakuliah_test.go
	   - nilai_test.go
